...
{
    public static WebApplicationBuilder RegisterDigitalLinkToolkit(this WebApplicationBuilder builder)
    {
    ...
    public static WebApplicationBuilder RegisterDigitalLinkResolver(this WebApplicationBuilder builder)
    {
